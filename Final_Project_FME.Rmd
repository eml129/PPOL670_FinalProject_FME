...
NATO_map <- NATO_edges_map %>%
  ...
  na.value = "antiquewhite",
  aesthetics = "fill") +
  labs(title="NATO Sponsors More FME Than", subtitle = "2021 African Leaders", fill = "Number of Leaders Trained") +
...
Warsaw_map <- Warsaw_edges_map %>%
  ...
  na.value = "antiquewhite",
  aesthetics = "fill") +
  labs(title="the Warsaw Pact/Russia", subtitle = "2021 African Leaders", fill = "# of Leaders Trained") +
